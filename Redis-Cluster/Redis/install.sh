...
sudo curl -o /etc/redis/redis-server.conf https://raw.githubusercontent.com/angviza/Production-Apps/master/Redis-Cluster/Redis/redis-server.conf
...
sudo curl -o /etc/systemd/system/redis-server.service https://raw.githubusercontent.com/angviza/Production-Apps/master/Redis-Cluster/Redis/redis-server.service
